...
import org.jcam.effects.EditorEffect;
import org.jcam.effects.LiveEffect;

import java.util.HashMap;
import java.util.Map;

public interface EditorEffectSingleton {
    Map<Class<? extends EditorEffect>, EditorEffect> uniqueInstances = new HashMap<>(); // Map already existing classes and their instances

    static <T extends EditorEffect> EditorEffect getUniqueInstance(Class<T> effectClass) {
        try {
